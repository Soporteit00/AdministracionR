...
function toggleInfo5() {
    var info = document.getElementById("informacion5");
    if (info.style.display === "none" || info.style.display === "") {
        info.style.display = "block";
    } else {
        info.style.display = "none";
...
function toggleInfo6() {
    var info = document.getElementById("informacion6");
    if (info.style.display === "none" || info.style.display === "") {
        info.style.display = "block";
    } else {
        info.style.display = "none";
...
function toggleInfo7() {
    var info = document.getElementById("informacion7");
    if (info.style.display === "none" || info.style.display === "") {
        info.style.display = "block";
    } else {
        info.style.display = "none";
...
function toggleInfo8() {
    var info = document.getElementById("informacion8");
    if (info.style.display === "none" || info.style.display === "") {
        info.style.display = "block";
    } else {
        info.style.display = "none";
